...
import {IconBrandDribbble, IconBrandGithub, IconBrandLinkedin, IconBrandTwitter, IconPokeball} from '@tabler/icons';
        ...
        <ContactPageStyled>
            ...
            <InformationCard title="Socials" tight>
                <IconLinks>
                    ...
                    <Typography size="lg"
                                onClick={() => window.open('https://dribbble.com/AdamBarta', '_blank')}><IconBrandDribbble/>
                        Check my designs on Dribbble</Typography>
                    <Typography size="lg"
